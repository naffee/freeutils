...
`);let f="";return i<2&&c>0?f="coords":f=n.shapeInfo.logicalShape.map((m,g)=>`coords.${h[g+d]}`).join(", "),`
  ...
  `}function D(n){if(n<=1)return"int";if(n===2)return"ivec2";if(n===3)return"ivec3";if(n===4)return"ivec4";if(n===5)return"ivec5";if(n===6)return"ivec6";throw Error(`GPU for rank ${n} is not yet supported`)}function Yt(n,e,t){const{newShape:s,keptDims:o}=Re(e),a=e.length,r=n&&a===3&&e[0]===1,c=r?e.slice(1):s,i=!n&&a>1&&!z(e,t)&&s.length<a||r;return{useSqueezeShape:i,uniformShape:i?c:e,keptDims:o}}function Le(n,e){const t=JSON.parse(JSON.stringify(n));return t.shapeInfo.logicalShape=e,t}function Be(n,e){return e.map(t=>n[t]).join(", ")}function yu(n,e,t,s){const o=t.map((l,d)=>{const p={logicalShape:l.shape,texShape:l.isUniform?null:l.texData.texShape,isUniform:l.isUniform,isPacked:l.isUniform?!1:l.texData.isPacked,flatOffset:null};return l.texData!=null&&l.texData.slice!=null&&l.texData.slice.flatOffset>0&&(p.flatOffset=l.texData.slice.flatOffset),{name:e.variableNames[d],shapeInfo:p}}),a=o.map(l=>l.shapeInfo),r={logicalShape:s.shape,texShape:s.texData.texShape,isUniform:!1,isPacked:s.texData.isPacked,flatOffset:null},c=Mc(o,r,e),i=Xn(n.gl,c),u=n.createProgram(i);return $().get("ENGINE_COMPILE_ONLY")?{program:e,fragmentShader:i,source:c,webGLProgram:u,inShapeInfos:a,outShapeInfo:r,variablesLocations:null,customUniformLocations:null,infLoc:null,nanLoc:null,outShapeLocation:null,outShapeStridesLocation:null,outTexShapeLocation:null}:(n.buildVao(u),Object.assign({program:e,fragmentShader:i,source:c,webGLProgram:u,inShapeInfos:a,outShapeInfo:r},gs(n,e,u)))}function gs(n,e,t){const s=[],o=[];let a,r,c,i=null,u=null;u=n.getUniformLocation(t,"NAN",!1),$().getNumber("WEBGL_VERSION")===1&&(i=n.getUniformLocation(t,"INFINITY",!1));const l=!1;for(const d of e.variableNames){const p={name:d,uniform:n.getUniformLocation(t,d,l),offset:n.getUniformLocation(t,`offset${d}`,l)};e.enableShapeUniforms&&(p.shape=n.getUniformLocation(t,`${d}Shape`,l),p.texShape=n.getUniformLocation(t,`${d}TexShape`,l)),s.push(p)}if(e.enableShapeUniforms&&(a=n.getUniformLocation(t,"outShape",l),c=n.getUniformLocation(t,"outShapeStrides",l),r=n.getUniformLocation(t,"outTexShape",l)),e.customUniforms)for(const d of e.customUniforms)o.push(n.getUniformLocation(t,d.name,l));return{variablesLocations:s,customUniformLocations:o,infLoc:i,nanLoc:u,outShapeLocation:a,outShapeStridesLocation:c,outTexShapeLocation:r}}function hn(n,e){if(n.length!==e.length)throw Error(`Binary was compiled with ${n.length} inputs, but was executed with ${e.length} inputs`);n.forEach((t,s)=>{const o=t.logicalShape,a=e[s],r=a.shape;if(!z(o,r))throw Error(`Binary was compiled with different shapes than the current args. Shapes ${o} and ${r} must match`);if(t.isUniform&&a.isUniform)return;const c=t.texShape,i=a.isUniform?null:a.texData.texShape;if(!z(c,i))throw Error(`Binary was compiled with different texture shapes than the current args. Shape ${c} and ${i} must match`)})}function wu(n,e,t,s,o){e.program.enableShapeUniforms||(hn(e.inShapeInfos,t),hn([e.outShapeInfo],[s]));const a=s.texData.texture,r=s.texData.texShape;s.texData.isPacked?n.setOutputPackedMatrixTexture(a.texture,r[0],r[1]):n.setOutputMatrixTexture(a.texture,r[0],r[1]),n.setProgram(e.webGLProgram),n.bindVertexArray(e.webGLProgram.vao),$().getNumber("WEBGL_VERSION")===1&&e.infLoc!==null&&n.gl.uniform1f(e.infLoc,1/0),e.nanLoc!==null&&n.gl.uniform1f(e.nanLoc,NaN);for(let i=0;i<t.length;++i){const u=t[i],{uniform:l,offset:d,shape:p,texShape:h}=e.variablesLocations[i];if(p){const{uniformShape:f}=Yt(e.program.packedInputs,u.shape,u.texData.texShape);switch(f.length){case 1:n.gl.uniform1iv(p,new Int32Array(f));break;case 2:n.gl.uniform2iv(p,new Int32Array(f));break;case 3:n.gl.uniform3iv(p,new Int32Array(f));break;case 4:n.gl.uniform4iv(p,new Int32Array(f));break}}if(h&&n.gl.uniform2i(h,u.texData.texShape[0],u.texData.texShape[1]),l!=null){if(u.isUniform){if(E(u.shape)<2)n.gl.uniform1f(l,u.uniformValues[0]);else{let f=u.uniformValues;f instanceof Float32Array||(f=new Float32Array(f)),n.gl.uniform1fv(l,f)}continue}u.texData.slice!=null&&d!=null&&n.gl.uniform1i(d,u.texData.slice.flatOffset),n.setInputMatrixTexture(u.texData.texture.texture,l,i)}}const c=e.outShapeLocation;if(c)switch(s.shape.length){case 1:n.gl.uniform1iv(c,new Int32Array(s.shape));break;case 2:n.gl.uniform2iv(c,new Int32Array(s.shape));break;case 3:n.gl.uniform3iv(c,new Int32Array(s.shape));break;case 4:n.gl.uniform4iv(c,new Int32Array(s.shape));break}if(e.outShapeStridesLocation){const i=Ae(s.shape);switch(s.shape.length){case 2:n.gl.uniform1iv(e.outShapeStridesLocation,new Int32Array(i));break;case 3:n.gl.uniform2iv(e.outShapeStridesLocation,new Int32Array(i));break;case 4:n.gl.uniform3iv(e.outShapeStridesLocation,new Int32Array(i));break}}if(e.outTexShapeLocation&&n.gl.uniform2i(e.outTexShapeLocation,s.texData.texShape[0],s.texData.texShape[1]),e.program.customUniforms&&o)for(let i=0;i<e.program.customUniforms.length;++i){const u=e.program.customUniforms[i],l=e.customUniformLocations[i],d=o[i];if(u.type==="float")n.gl.uniform1fv(l,d);else if(u.type==="vec2")n.gl.uniform2fv(l,d);else if(u.type==="vec3")n.gl.uniform3fv(l,d);else if(u.type==="vec4")n.gl.uniform4fv(l,d);else if(u.type==="int")n.gl.uniform1iv(l,d);else if(u.type==="ivec2")n.gl.uniform2iv(l,d);else if(u.type==="ivec3")n.gl.uniform3iv(l,d);else if(u.type==="ivec4")n.gl.uniform4iv(l,d);else throw Error(`uniform type ${u.type} is not supported yet.`)}n.executeProgram()}function Tu(n,e,t){let s="";e.concat(t).forEach(r=>{const c=r.texData!=null&&r.texData.slice!=null&&r.texData.slice.flatOffset>0;if(n.enableShapeUniforms&&!r.isUniform){const i=r.texData.texShape,{useSqueezeShape:u,uniformShape:l,keptDims:d}=Yt(n.packedInputs,r.shape,i);let p="",h="",f="";if(l.length===1&&n.packedInputs){const R=[Math.ceil(i[0]/2),Math.ceil(i[1]/2)];p=`${R[0]>1}_${R[1]>1}`}else if(l.length===2&&!n.packedInputs)h=`${l[0]>1}_${l[1]>1}`;else if(l.length>2&&!n.packedInputs){const R=Ae(l);f=`${R[0]===i[1]}_${R[R.length-1]===i[1]}`}const m=r.shape.length,g=l.length===2&&z(r.shape,i),x=E(r.shape)===1,C=go(r.shape,t.shape),b=!n.packedInputs&&m===t.shape.length&&z(i,t.texData.texShape),v=n.packedInputs||l.length>2?"":`${i[0]>1}_${i[1]>1}`;s+=`${m}_${b}_${u?d:""}_${l.length}_${x}_${C}_${g}_${p}_${h}_${f}_${v}_${c}`}else{const i=r.isUniform?"uniform":r.texData.texShape;s+=`${r.shape}_${i}_${c}`}});const o=n.userCode;let a=n.constructor.name;return a+="_"+s+"_"+o+`${$().getNumber("WEBGL_VERSION")}`,a}function V(n){return $().getBool("WEBGL_USE_SHAPES_UNIFORMS")&&n<=4}class Iu{constructor(e){this.variableNames=["A"],this.packedInputs=!1,this.packedOutput=!0,this.outPackingScheme=Xe.DENSE,this.customUniforms=[{name:"texShape",type:"ivec2"}];const t=G();this.outputShape=e,this.enableShapeUniforms=V(this.outputShape.length),this.userCode=`
    ...
    `}getOutput(e){const t=this.getSourceCoordsArr(e);return this.rank===1?`getA(rc), (rc + 1 >= ${this.enableShapeUniforms?"outShape":this.outputShape[0]} ? 0. : getA(rc + 1)), 0, 0`:`getA(${t[0]}),
            cEdge ? 0. : getA(${t[1]}),
            rEdge ? 0. : getA(${t[2]}),
            rEdge || cEdge ? 0. : getA(${t[3]})`}}class Bs{constructor(e,t){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!0,this.customUniforms=[{name:"inputShape",type:"ivec3"}],this.outputShape=e,this.enableShapeUniforms=V(this.outputShape.length);let s="";for(let o=0;o<4;o++){let a="thisRC = rc;";o%2===1&&(a+="thisRC.z += 1;"),o>1&&(a+="thisRC.y += 1;"),s+=`
        ${a}
...
`,le="return x;",_l="return 1.0 / (1.0 + exp(-1.0 * x));";const Ll="return x;",Bl=`
  vec4 result;
...
`;function nd(n){const{inputs:e,backend:t}=n,{x:s,alpha:o}=e,a=$().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new Ve(Ms,s.shape,o.shape):new be(Ws,s.shape,o.shape);return t.runWebGLProgram(a,[s,o],"float32")}const sd={kernelName:Do,backendName:"webgl",kernelFunc:nd};const Ue="if (isnan(x)) return x;";function A({opSnippet:n,packedOpSnippet:e,cpuKernelImpl:t,dtype:s}){return({inputs:o,backend:a})=>{const{x:r}=o,c=a,i=s||r.dtype;if(c.shouldExecuteOnCPU([r])&&t!=null){const d=c.texData.get(r.dataId),p=t(d.values,i);return c.makeTensorInfo(r.shape,i,p)}const u=$().getBool("WEBGL_PACK_UNARY_OPERATIONS")&&e!=null;let l;return u?l=new de(r.shape,e):l=new ae(r.shape,n),c.runWebGLProgram(l,[r],i)}}function B({opSnippet:n,packedOpSnippet:e,checkOutOfBounds:t=!1,supportsComplex:s=!1,cpuKernelImpl:o,dtype:a}){return({inputs:r,backend:c})=>{const{a:i,b:u}=r,l=c;if(s&&i.dtype==="complex64"){const f=l.texData.get(i.dataId),m=l.texData.get(u.dataId),[g,x]=[[f.complexTensorInfos.real,m.complexTensorInfos.real],[f.complexTensorInfos.imag,m.complexTensorInfos.imag]].map(b=>{const[v,R]=b,N={dataId:v.dataId,dtype:v.dtype,shape:i.shape},I={dataId:R.dataId,dtype:R.dtype,shape:u.shape},w=new be(n,i.shape,u.shape);return l.runWebGLProgram(w,[N,I],ke(v.dtype,R.dtype))}),C=xe({inputs:{real:g,imag:x},backend:l});return l.disposeIntermediateTensorInfo(g),l.disposeIntermediateTensorInfo(x),C}const d=a||ke(i.dtype,u.dtype);if((i.dtype==="string"||u.dtype==="string"||l.shouldExecuteOnCPU([i,u]))&&o!=null){const f=l.texData.get(i.dataId).values,m=l.texData.get(u.dataId).values,g=i.dtype==="string"?At(f):f,x=i.dtype==="string"?At(m):m,[C,b]=o(i.shape,u.shape,g,x,d),v=l.makeTensorInfo(b,d),R=l.texData.get(v.dataId);return R.values=C,v}const p=$().getBool("WEBGL_PACK_BINARY_OPERATIONS")&&e!=null;let h;return p?h=new Ve(e,i.shape,u.shape,t):h=new be(n,i.shape,u.shape),l.runWebGLProgram(h,[i,u],d)}}function je(n,e=!1){if(n==="linear")return e?Ll:Al;if(n==="relu")return e?Vl:Pl;if(n==="elu")return e?Bl:Dl;if(n==="relu6")return e?Ul:Fl;if(n==="prelu")return e?Ms:Ws;if(n==="leakyrelu")return e?Us:Vs;if(n==="sigmoid")return e?Wl:_l;throw new Error(`Activation ${n} has not been implemented for the WebGL backend.`)}class Gs{constructor(e,t,s,o=!1,a=!1,r=!1,c=null,i=!1,u=!1){this.variableNames=["matrixA","matrixB"],this.packedInputs=!0,this.packedOutput=!0,this.outputShape=s,this.enableShapeUniforms=V(this.outputShape.length);const l=o?e[1]:e[2],d=Math.ceil(l/2),p=o?"i * 2, rc.y":"rc.y, i * 2",h=a?"rc.z, i * 2":"i * 2, rc.z",f=o?["a.xxyy","a.zzww"]:["a.xxzz","a.yyww"],m=a?["b.xzxz","b.ywyw"]:["b.xyxy","b.zwzw"];let g="",x="";c&&(i?g=`vec4 activation(vec4 a) {
    ...
    `}}function yt(n,e,t){const s=$().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new dd(n.shape,e):new ud(n.shape,e);return t.runWebGLProgram(s,[n],n.dtype)}function pd(n,e,t,s){const o=e,a=n.shape.length,r=K(o,n.shape);let c=r;const i=ne(c,a),u=i!=null;let l=n;u&&(l=yt(n,i,s),c=se(c.length,a)),re("sum",c,a);const[d,p]=pe(l.shape,c);let h=d;t&&(h=he(d,r));const f=E(p),g=E(n.shape)/f,x=S({inputs:{x:l},attrs:{shape:[g,f]},backend:s}),C=Gt(n.dtype),b=Te(x,C,"sum",s),v=S({inputs:{x:b},attrs:{shape:h},backend:s});return s.disposeIntermediateTensorInfo(x),s.disposeIntermediateTensorInfo(b),u&&s.disposeIntermediateTensorInfo(l),v}function wt(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:a,keepDims:r}=s;return pd(o,a,r,t)}const hd={kernelName:Bo,backendName:"webgl",kernelFunc:wt};function M(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{perm:a}=s,r=t,c=o.shape.length,i=new Array(c);for(let l=0;l<i.length;l++)i[l]=o.shape[a[l]];let u;if(r.shouldExecuteOnCPU([o])){const d=r.texData.get(o.dataId).values,p=nn(d,o.shape,o.dtype,a,i);u=r.makeTensorInfo(i,o.dtype);const h=r.texData.get(u.dataId);h.values=p}else u=yt(o,a,r);return u}const fd={kernelName:Vo,backendName:"webgl",kernelFunc:M};const zs=1e3;function mt({a:n,b:e,transposeA:t,transposeB:s,backend:o,bias:a=null,preluActivationWeights:r=null,leakyreluAlpha:c=0,activation:i=null}){const u=n.shape.length,l=e.shape.length,d=t?n.shape[u-2]:n.shape[u-1],p=s?e.shape[l-1]:e.shape[l-2],h=t?n.shape[u-1]:n.shape[u-2],f=s?e.shape[l-2]:e.shape[l-1],m=n.shape.slice(0,-2),g=e.shape.slice(0,-2),x=E(m),C=E(g),v=q(n.shape.slice(0,-2),e.shape.slice(0,-2)).concat([h,f]);_(d===p,()=>`Error in matMul: inner shapes (${d}) and (${p}) of Tensors with shapes ${n.shape} and ${e.shape} and transposeA=${t} and transposeB=${s} must match.`);const R=t?[x,d,h]:[x,h,d],N=s?[C,f,p]:[C,p,f],I=S({inputs:{x:n},backend:o,attrs:{shape:R}}),w=S({inputs:{x:e},backend:o,attrs:{shape:N}}),O=[I,w],k=Math.max(x,C),P=t?I.shape[1]:I.shape[2],F=a!=null,oe=r!=null,H=i==="leakyrelu",j=i!=null?je(i,!0):null,Z=F||oe||H||j!=null;let ee;if((h===1||f===1)&&P>zs&&Z===!1){let ce=I,Ie=w;t&&(ce=M({inputs:{x:I},backend:o,attrs:{perm:[0,2,1]}}),O.push(ce)),s&&(Ie=M({inputs:{x:w},backend:o,attrs:{perm:[0,2,1]}}),O.push(Ie));const Ne=f!==1,ot=f===1;let It=ce;Ne&&(It=S({inputs:{x:ce},backend:o,attrs:{shape:[k,P,1]}}),O.push(It));const xo=f===1?2:1;let Nt=Ie;ot&&(Nt=S({inputs:{x:Ie},backend:o,attrs:{shape:[k,1,P]}}),O.push(Nt));const cn=on({inputs:{a:It,b:Nt},backend:o});ee=wt({inputs:{x:cn},backend:o,attrs:{axis:xo,keepDims:!0}}),O.push(cn)}else{const ce=ke(n.dtype,e.dtype),Ie=new Gs(R,N,[k,h,f],t,s,F,j,oe,H),Ne=[I,w];if(a!=null&&Ne.push(a),oe&&Ne.push(r),H){const ot=o.makeTensorInfo([],"float32",Qe(c,"float32"));Ne.push(ot),O.push(ot)}ee=o.runWebGLProgram(Ie,Ne,ce)}const U=S({inputs:{x:ee},backend:o,attrs:{shape:v}});O.push(ee);for(const ce of O)o.disposeIntermediateTensorInfo(ce);return U}function xd(n){const{inputs:e,backend:t,attrs:s}=n,{a:o,b:a,bias:r,preluActivationWeights:c}=e,{transposeA:i,transposeB:u,activation:l,leakyreluAlpha:d}=s;return mt({a:o,b:a,transposeA:i,transposeB:u,backend:t,bias:r,preluActivationWeights:c,leakyreluAlpha:d,activation:l})}const md={kernelName:Uo,backendName:"webgl",kernelFunc:xd};const Sn="return abs(x);";function gd(n){const{inputs:e,backend:t}=n,{x:s}=e;if(t.shouldExecuteOnCPU([s])&&s.dtype!=="complex64"){const a=t.texData.get(s.dataId),r=Fs(a.values);return t.makeTensorInfo(s.shape,s.dtype,r)}let o;return $().getBool("WEBGL_PACK_UNARY_OPERATIONS")?o=new de(s.shape,Sn):o=new ae(s.shape,Sn),t.runWebGLProgram(o,[s],s.dtype)}const Cd={kernelName:Wo,backendName:"webgl",kernelFunc:gd};const $d=J+`
  if (abs(x) > 1.) {
    return NAN;
  }
  return acos(x);
`,vd=A({opSnippet:$d}),bd={kernelName:Mo,backendName:"webgl",kernelFunc:vd};const Rd=J+`
  if (x < 1.0) return NAN;
return log(x + sqrt(x * x - 1.0));`,Sd=A({opSnippet:Rd}),yd={kernelName:Go,backendName:"webgl",kernelFunc:Sd};const yn="return a + b;",wd=B({opSnippet:yn,packedOpSnippet:yn,supportsComplex:!0,cpuKernelImpl:Pu}),Td={kernelName:zo,backendName:"webgl",kernelFunc:wd};class Id{constructor(e,t){this.outputShape=[],this.outputShape=e,this.variableNames=t.map((a,r)=>`T${r}`);const s=[];this.variableNames.forEach(a=>{s.push(`float v${a} = get${a}AtOutCoords();`)});const o=this.variableNames.map(a=>`v${a}`).join(" + ");this.userCode=`
      void main() {
        ${s.join(`
        `)}
    ...
    `}}function ft(n){const{inputs:e,backend:t}=n,s=e;if(s.length===1)return X({inputs:{x:s[0]},backend:t});if(s.length>$().getNumber("WEBGL_MAX_TEXTURES_IN_SHADER")){const i=Math.floor(s.length/2),u=ft({inputs:s.slice(0,i),backend:t}),l=ft({inputs:s.slice(i),backend:t});return ft({inputs:[u,l],backend:t})}const o=s.map(i=>i.dtype).reduce((i,u)=>ke(i,u)),a=s.map(i=>i.shape),c=$().getBool("WEBGL_PACK")?new Nd(s[0].shape,a):new Id(s[0].shape,a);return t.runWebGLProgram(c,s,o)}const Ed={kernelName:Ho,backendName:"webgl",kernelFunc:ft};function kd(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:a,keepDims:r}=s,c=o.shape.length,i=K(a,o.shape);let u=i;const l=ne(u,c);let d=o;l!=null&&(d=M({inputs:{x:o},backend:t,attrs:{perm:l}}),u=se(u.length,c)),re("all",u,c);const[p,h]=pe(d.shape,u),f=E(h),m=S({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),g=Te(m,m.dtype,"all",t);let x;if(r){const C=he(p,i);x=S({inputs:{x:g},backend:t,attrs:{shape:C}})}else x=S({inputs:{x:g},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(g),l!=null&&t.disposeIntermediateTensorInfo(d),x}const Od={kernelName:Xo,backendName:"webgl",kernelFunc:kd};function Ad(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:a,keepDims:r}=s,c=o.shape.length,i=K(a,o.shape);let u=i;const l=ne(u,c);let d=o;l!=null&&(d=M({inputs:{x:o},backend:t,attrs:{perm:l}}),u=se(u.length,c)),re("any",u,c);const[p,h]=pe(d.shape,u),f=E(h),m=S({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),g=Te(m,m.dtype,"any",t);let x;if(r){const C=he(p,i);x=S({inputs:{x:g},backend:t,attrs:{shape:C}})}else x=S({inputs:{x:g},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(g),l!=null&&t.disposeIntermediateTensorInfo(d),x}const Dd={kernelName:Ko,backendName:"webgl",kernelFunc:Ad};class Pd{constructor(e,t,s){this.variableNames=["A"];const{windowSize:o,batchSize:a,outSize:r}=e;s||this.variableNames.push("bestIndicesA"),this.outputShape=[a,r];const c=t==="max"?">":"<",i=s?"inOffset + i;":"round(getBestIndicesA(batch, inOffset + i));";this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
        int batch = coords[0];
        int outIdx = coords[1];
    ...
    `}}function Hs(n,e,t,s=null){let o=e.shape[0],a=e.shape[1];s!=null&&(o=s.shape[0],a=s.shape[1]);const r=Mt(a),c={windowSize:r,inSize:a,batchSize:o,outSize:Math.ceil(a/r)},i=new Pd(c,t,s==null),u=[e];s!=null&&u.push(s);const l=n.runWebGLProgram(i,u,"int32");if(l.shape[1]===1)return l;const d=Hs(n,e,t,l);return n.disposeIntermediateTensorInfo(l),d}function Xs(n,e,t,s=null){const o=s!=null?s.shape:e.shape,a=o[o.length-1],r=Mt(a),c=new Fd(o,r,t,s==null),i=s==null?[e]:[e,s],u=n.runWebGLProgram(c,i,"int32");if(u.shape.length===e.shape.length){const l=Xs(n,e,t,u);return n.disposeIntermediateTensorInfo(u),l}return u}function Ks(n,e,t,s){const o=[t];if(re("arg"+s.charAt(0).toUpperCase()+s.slice(1),o,e.shape.length),!$().getBool("WEBGL_PACK_REDUCE")||e.shape.length<=2){const a=[],r=n.texData.get(e.dataId),c=r!==null&&r.isPacked;let i=e;c&&(i=n.unpackTensor(e),a.push(i));const[u,l]=pe(i.shape,o),d=E(l),p=S({inputs:{x:i},backend:n,attrs:{shape:[-1,d]}});a.push(p);const h=Hs(n,p,s);a.push(h);const f=S({inputs:{x:h},backend:n,attrs:{shape:u}});return a.forEach(m=>n.disposeIntermediateTensorInfo(m)),f}return Xs(n,e,s)}function _d(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:a}=s;let r=K(a,o.shape);const c=ne(r,o.shape.length);let i=o;const u=[];c!=null&&(i=M({inputs:{x:o},backend:t,attrs:{perm:c}}),u.push(i),r=se(r.length,i.shape.length)),re("argMax",[r[0]],i.shape.length);const l=Ks(t,i,r[0],"max");return u.forEach(d=>t.disposeIntermediateTensorInfo(d)),l}const Ld={kernelName:jo,backendName:"webgl",kernelFunc:_d};function Bd(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:a}=s;let r=K(a,o.shape);const c=ne(r,o.shape.length);let i=o;const u=[];c!=null&&(i=M({inputs:{x:o},backend:t,attrs:{perm:c}}),u.push(i),r=se(r.length,i.shape.length)),re("argMin",[r[0]],i.shape.length);const l=Ks(t,i,r[0],"min");return u.forEach(d=>t.disposeIntermediateTensorInfo(d)),l}const Vd={kernelName:qo,backendName:"webgl",kernelFunc:Bd};const Ud=J+`
  if (abs(x) > 1.) {
    return NAN;
  }
  return asin(x);
`,Wd=A({opSnippet:Ud}),Md={kernelName:Yo,backendName:"webgl",kernelFunc:Wd};const Gd=J+"return log(x + sqrt(x * x + 1.0));",zd=A({opSnippet:Gd}),Hd={kernelName:Qo,backendName:"webgl",kernelFunc:zd};const Xd=J+`
  return atan(x);
`,Kd=A({opSnippet:Xd}),jd={kernelName:Zo,backendName:"webgl",kernelFunc:Kd};const qd=sn+`
  return atan(a, b);
`,Yd=`
  ...
  `+we+`
  return result;
`,Qd=B({opSnippet:qd,packedOpSnippet:Yd}),Zd={kernelName:Jo,backendName:"webgl",kernelFunc:Qd};const Jd=J+`
  if ((x < -1.0) || (x > 1.0)) return NAN;
return (log(1.0 + x) - log(1.0 - x)) / 2.0;`,ep=A({opSnippet:Jd}),tp={kernelName:ea,backendName:"webgl",kernelFunc:ep};class qe{constructor(e,t,s,o=!1,a=!1){if(this.variableNames=["x"],t==="avg"&&s)throw new Error("Cannot compute positions for average pool.");const r=e.filterWidth,c=e.strideHeight,i=e.strideWidth,u=e.dilationHeight,l=e.dilationWidth,d=e.effectiveFilterHeight,p=e.effectiveFilterWidth,h=e.padInfo.top,f=e.padInfo.left;this.outputShape=e.outShape;const m=t==="avg",g=`((batch  * ${e.inHeight} + xR) * ${e.inWidth} + xC) * ${e.inChannels} + d`,x=`(xR * ${e.inWidth} + xC) * ${e.inChannels} + d`;let C="0.0";if(m||(C="-1.0 / 1e-20"),s){this.userCode=`
    ...
    `}}function cp(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:a}=e,r=a,{filterSize:c,strides:i,pad:u,dimRoundingMode:l}=s,d=[1,1,1],p=vt(r.shape,c,i,d,u,l),h=new ip(p);return t.runWebGLProgram(h,[o],r.dtype)}const up={kernelName:sa,backendName:"webgl",kernelFunc:cp};function lp(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:a}=e,r=a;Pe([o,a],"avgPoolGrad");const{filterSize:c,strides:i,pad:u}=s,l=Je(r.shape,c,i,1,u),d=new rp(l);return t.runWebGLProgram(d,[o],r.dtype)}const dp={kernelName:oa,backendName:"webgl",kernelFunc:lp};function pp(n){const{inputs:e,backend:t,attrs:s}=n,{a:o,b:a}=e,{transposeA:r,transposeB:c}=s;return mt({a:o,b:a,transposeA:r,transposeB:c,backend:t})}const hp={kernelName:aa,backendName:"webgl",kernelFunc:pp};class fp{constructor(e,t,s,o,a,r){this.outputShape=[],this.variableNames=["x","mean","variance"],q(e,t),q(e,s);let c="0.0";o!=null&&(q(e,o),this.variableNames.push("offset"),c="getOffsetAtOutCoords()");let i="1.0";a!=null&&(q(e,a),this.variableNames.push("scale"),i="getScaleAtOutCoords()"),this.outputShape=e,this.userCode=`
      void main() {
    ...
    `}}const mp=({inputs:n,backend:e,attrs:t})=>{const{x:s,mean:o,variance:a,offset:r,scale:c}=n;_(o.shape.length===a.shape.length,()=>"Batch normalization gradient requires mean and variance to have equal ranks."),_(r==null||o.shape.length===r.shape.length,()=>"Batch normalization gradient requires mean and offset to have equal ranks."),_(c==null||o.shape.length===c.shape.length,()=>"Batch normalization gradient requires mean and scale to have equal ranks.");let{varianceEpsilon:i}=t;i==null&&(i=.001);const u=[s,o,a];let l=null;r!=null&&(l=r.shape,u.push(r));let d=null;c!=null&&(d=c.shape,u.push(c));const p=$().getBool("WEBGL_PACK_NORMALIZATION")?new xp(s.shape,o.shape,a.shape,l,d,i):new fp(s.shape,o.shape,a.shape,l,d,i);return e.runWebGLProgram(p,u,u[0].dtype)},gp={kernelName:ra,backendName:"webgl",kernelFunc:mp};class Cp{constructor(e){this.variableNames=["source"],this.outputShape=e,this.rank=e.length;const t=D(this.rank);this.customUniforms=[{name:"start",arrayIndex:this.rank,type:"int"}];const s=$p(this.rank);let o;const a=e.map((r,c)=>`sourceLoc.${Lt[c]} = start[${c}] + coords.${Lt[c]};`);o=`
        ${t} sourceLoc;
...
`;function Ep(n){const{inputs:e,backend:t}=n,{a:s,b:o}=e,a=$().getBool("WEBGL_PACK_BINARY_OPERATIONS"),r=$().getNumber("WEBGL_VERSION");if(t.shouldExecuteOnCPU([s,o])||r===1){const i=t.texData.get(s.dataId).values,u=t.texData.get(o.dataId).values,[l,d]=_u(s.shape,o.shape,i,u,s.dtype),p=t.makeTensorInfo(d,s.dtype),h=t.texData.get(p.dataId);return h.values=l,p}let c;return a?c=new Ve(Ip,s.shape,o.shape,!1):c=new be(Np,s.shape,o.shape),t.runWebGLProgram(c,[s,o],s.dtype)}const kp={kernelName:ma,backendName:"webgl",kernelFunc:Ep};function Op(n){const{inputs:e,backend:t}=n,{s0:s,s1:o}=e,a=t.readSync(s.dataId),r=t.readSync(o.dataId),c=q(Array.from(a),Array.from(r));return t.makeTensorInfo([c.length],"int32",Int32Array.from(c))}const Ap={kernelName:ga,backendName:"webgl",kernelFunc:Op};const Dp="return float(a != b);",js=B({opSnippet:Dp,cpuKernelImpl:sl,dtype:"bool"}),Pp={kernelName:Ca,backendName:"webgl",kernelFunc:js};function nt(n){const{inputs:e,backend:t}=n,{input:s}=e,o=t.texData.get(s.dataId);return X({inputs:{x:o.complexTensorInfos.real},backend:t})}const Fp={kernelName:$a,backendName:"webgl",kernelFunc:nt};const _p="return float(int(x));";function Lp(n,e){const t=new ae(n.shape,_p),s=e.runWebGLProgram(t,[n],"int32");return{dataId:s.dataId,shape:s.shape,dtype:s.dtype}}function Bt(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{dtype:a}=s;if(a==="complex64"){if(o.dtype==="complex64")return X({inputs:{x:o},backend:t});const r=ba(o.shape),c=Bt({inputs:{x:o},backend:t,attrs:{dtype:"float32"}}),i=xe({inputs:{real:c,imag:r},backend:t});return r.dispose(),t.disposeIntermediateTensorInfo(c),i}if(o.dtype==="complex64"){const r=nt({inputs:{input:o},backend:t}),c=Bt({inputs:{x:r},backend:t,attrs:{dtype:a}});return t.disposeIntermediateTensorInfo(r),c}if(!Ra(o.dtype,a)){const r=X({inputs:{x:o},backend:t});return{dataId:r.dataId,shape:r.shape,dtype:a}}if(t.shouldExecuteOnCPU([o])){const r=t.texData.get(o.dataId).values,[c,i,u]=Lu(r,o.shape,o.dtype,a);return t.makeTensorInfo(c,i,u)}if(a==="int32")return Lp(o,t);if(a==="bool"){const r=t.makeTensorInfo([],"bool",Bn("bool",1)),i=js({inputs:{a:o,b:r},backend:t});return t.disposeIntermediateTensorInfo(r),i}throw new Error(`Error in Cast: failed to cast ${o.dtype} to ${a}`)}const Bp={kernelName:va,backendName:"webgl",kernelFunc:Bt};const wn="return ceil(x);",Vp=A({opSnippet:wn,packedOpSnippet:wn,cpuKernelImpl:Bu}),Up={kernelName:Sa,backendName:"webgl",kernelFunc:Vp};class Wp{constructor(e){this.variableNames=["A"],this.customUniforms=[{name:"minVal",type:"float"},{name:"maxVal",type:"float"}],this.outputShape=e,this.userCode=`
    ...
    `}}function Gp(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{clipValueMin:a,clipValueMax:r}=s;let c;$().getBool("WEBGL_PACK_CLIP")?c=new Mp(o.shape):c=new Wp(o.shape);const i=[[a],[r]];return t.runWebGLProgram(c,[o],o.dtype,i)}const zp={kernelName:ya,backendName:"webgl",kernelFunc:Gp};class Hp{constructor(e){this.variableNames=["real","imag"],this.outputShape=e,this.userCode=`
      void main() {
   ...
   `;let h="",f="";s&&(o?h=`vec4 activation(vec4 a) {
    ...
    `}}function ih(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,dy:a}=e,{strides:r,pad:c,dataFormat:i,dimRoundingMode:u,filterShape:l}=s,d=bt(i),p=fe(o.shape,l,r,1,c,u,!1,d),h=new sh(p);return t.runWebGLProgram(h,[o,a],"float32")}const ch={kernelName:ka,backendName:"webgl",kernelFunc:ih};class uh{constructor(e){this.variableNames=["dy","W"],this.packedInputs=!0,this.packedOutput=!0,this.customUniforms=[{name:"strides",type:"vec2"}],this.outputShape=e.inShape,this.enableShapeUniforms=V(this.outputShape.length);const t=e.filterHeight,s=e.filterWidth,o=t-1-e.padInfo.top,a=s-1-e.padInfo.left;this.userCode=`
    ...
    `}}function lh(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,filter:a}=e,{inputShape:r,strides:c,pad:i,dataFormat:u,dimRoundingMode:l}=s,d=bt(u),p=fe(r,a.shape,c,1,i,l,!1,d);if($().getBool("WEBGL_PACK_CONV2DTRANSPOSE")&&d==="channelsLast"){const h=[[p.strideHeight,p.strideWidth]],f=new uh(p);return t.runWebGLProgram(f,[o,a],"float32",h)}else{const h=new oh(p);return t.runWebGLProgram(h,[o,a],"float32")}}const dh={kernelName:Oa,backendName:"webgl",kernelFunc:lh};function ph(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,filter:a}=e,{strides:r,pad:c,dilations:i}=s,u=zt(o.shape,a.shape,r,i,c),l=new Jp(u);return t.runWebGLProgram(l,[o,a],"float32")}const hh={kernelName:Aa,backendName:"webgl",kernelFunc:ph};function fh(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,dy:a}=e,{strides:r,pad:c,filterShape:i}=s,u=zt(o.shape,i,r,1,c),l=new ah(u);return t.runWebGLProgram(l,[o,a],"float32")}const xh={kernelName:Da,backendName:"webgl",kernelFunc:fh};function mh(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,filter:a}=e,{pad:r,strides:c,inputShape:i}=s,u=zt(i,a.shape,c,1,r),l=new rh(u);return t.runWebGLProgram(l,[o,a],"float32")}const gh={kernelName:Pa,backendName:"webgl",kernelFunc:mh};const Ch=Ue+`
  return cos(x);
`,$h=`
  vec4 result = cos(x);
  bvec4 isNaN = isnan(x);
...
`,Sh=A({opSnippet:Rh}),yh={kernelName:_a,backendName:"webgl",kernelFunc:Sh};class wh{constructor(e,t,s,o,a){this.variableNames=["Image","Boxes","BoxInd"],this.outputShape=[];const[r,c,i,u]=e,[l]=t,[d,p]=s;this.outputShape=[l,d,p,u];const h=o==="bilinear"?1:0,[f,m]=[`${c-1}.0`,`${i-1}.0`],[g,x,C]=d>1?[`${(c-1)/(d-1)}`,"(y2-y1) * height_ratio",`y1*${f} + float(y)*(height_scale)`]:["0.0","0.0",`0.5 * (y1+y2) * ${f}`],[b,v,R]=p>1?[`${(i-1)/(p-1)}`,"(x2-x1) * width_ratio",`x1*${m} + float(x)*(width_scale)`]:["0.0","0.0",`0.5 * (x1+x2) * ${m}`];this.userCode=`
    ...
    `}}function Nn(n,e,t){if(n===1)return`${e}`;if(n===2)return`${e}.x, ${e}.y`;if(n===3)return`${e}.x, ${e}.y, ${e}.z`;if(n===4)return`${e}.x, ${e}.y, ${e}.z, ${e}.w`;throw new Error(`Cumulative ${t} for rank ${n} is not yet supported`)}function En(n,e,t){if(n===1)return`${e}`;if(n===2)return`${e}.y`;if(n===3)return`${e}.z`;if(n===4)return`${e}.w`;throw new Error(`Cumulative ${t} for rank ${n} is not yet supported`)}function eo(n,e,t,s,o,a){const r=e.shape.length,c=ne([s],r);let i=e;c!=null&&(i=M({inputs:{x:e},backend:t,attrs:{perm:c}}));const u=se(1,r)[0];if(u!==r-1)throw new Error(`WebGL cumprod shader expects an inner-most axis=${e.shape.length-1} but got axis=${s}`);const l=i.shape[u];let d=X({inputs:{x:i},backend:t});for(let p=0;p<=Math.ceil(Math.log2(l))-1;p++){const h=new In(n,i.shape,!1,a),f=[[p]],m=d;d=t.runWebGLProgram(h,[d],d.dtype,f),t.disposeIntermediateTensorInfo(m)}if(o){const p=new In(n,i.shape,o,a),h=d;d=t.runWebGLProgram(p,[d],d.dtype),t.disposeIntermediateTensorInfo(h)}if(c!=null){const p=Mn(c),h=M({inputs:{x:d},backend:t,attrs:{perm:p}});return t.disposeIntermediateTensorInfo(d),t.disposeIntermediateTensorInfo(i),h}return d}function Nh(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:a,exclusive:r,reverse:c}=s;return eo(Ye.Prod,o,t,a,r,c)}const Eh={kernelName:Ba,backendName:"webgl",kernelFunc:Nh};function kh(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:a,exclusive:r,reverse:c}=s;return eo(Ye.Sum,o,t,a,r,c)}const Oh={kernelName:Va,backendName:"webgl",kernelFunc:kh};function Ah(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,weights:a}=e,{size:r,binaryOutput:c}=s;if(o.shape.length===1){const i=t.readSync(o.dataId),u=t.readSync(a.dataId),l=Ps(i,u,a.dtype,a.shape,r);return t.makeTensorInfo([r],a.dtype,l)}else if(o.shape.length===2){const i=t.bufferSync(o),u=t.bufferSync(a),l=Fu(i,u,r,c);return t.makeTensorInfo(l.shape,a.dtype,l.values)}throw new Error(`Error in denseBincount: input must be at most rank 2, but got rank${o.shape.length}.`)}const Dh={kernelName:Ua,backendName:"webgl",kernelFunc:Ah};class Ph{constructor(e,t,s){this.variableNames=["x"],this.outputShape=[],this.outputShape=e,this.blockSize=t,this.dataFormat=s,this.userCode=`
    void main() {
      ivec4 coords = getOutputCoords();
      int b = coords[0];
  ...
  `,h+=`
    ...
    `}}function Wh(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,dy:a}=e,{strides:r,dilations:c,pad:i,dimRoundingMode:u,filterShape:l}=s,d=fe(o.shape,l,r,c,i,u,!0),p=new Vh(d);return t.runWebGLProgram(p,[o,a],"float32")}const Mh={kernelName:Ga,backendName:"webgl",kernelFunc:Wh};function Gh(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,filter:a}=e,{strides:r,dilations:c,pad:i,dimRoundingMode:u,inputShape:l}=s,d=fe(l,a.shape,r,c,i,u,!0),p=new Uh(d);return t.runWebGLProgram(p,[o,a],"float32")}const zh={kernelName:za,backendName:"webgl",kernelFunc:Gh};class Hh{constructor(e){this.variableNames=["X"],this.outputShape=[e,e],this.userCode=`
      void main() {
          ivec2 coords = getOutputCoords();
          float val = coords[0] == coords[1] ? getX(coords[0]) : 0.0;
          setOutput(val);
      }
    `}}function Xh(n){const{inputs:e,backend:t}=n,{x:s}=e,o=[...s.shape,...s.shape],a=E(s.shape),r=S({inputs:{x:s},backend:t,attrs:{shape:[a]}}),c=new Hh(a),i=t.runWebGLProgram(c,[r],r.dtype),u=S({inputs:{x:i},backend:t,attrs:{shape:o}});return t.disposeIntermediateTensorInfo(r),t.disposeIntermediateTensorInfo(i),u}const Kh={kernelName:Ha,backendName:"webgl",kernelFunc:Xh};class jh{constructor(e){this.variableNames=["x","W"],this.outputShape=e.outShape;const{inHeight:t,inWidth:s,padInfo:o,strideHeight:a,strideWidth:r,filterHeight:c,filterWidth:i,dilationHeight:u,dilationWidth:l}=e,{top:d,left:p}=o;this.userCode=`
  ...
  return result;
`,tf=A({opSnippet:Jh,packedOpSnippet:ef}),nf={kernelName:er,backendName:"webgl",kernelFunc:tf};const sf="return (b >= 0.0) ? a : a * (b + 1.0);",of=`
  vec4 bGTEZero = vec4(greaterThanEqual(b, vec4(0.)));
  return (bGTEZero * a) + ((vec4(1.0) - bGTEZero) * (a * (b + vec4(1.0))));
`,af=n=>{const{inputs:e,backend:t}=n,{dy:s,y:o}=e,a=$().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new Ve(of,s.shape,o.shape):new be(sf,s.shape,o.shape);return t.runWebGLProgram(a,[s,o],s.dtype)},rf={kernelName:tr,backendName:"webgl",kernelFunc:af};const cf=`
  return vec4(equal(a, b));
`,uf="return float(a == b);",lf=B({opSnippet:uf,packedOpSnippet:cf,dtype:"bool",cpuKernelImpl:Uu}),df={kernelName:nr,backendName:"webgl",kernelFunc:lf};const pf=`
...
`,hf=A({opSnippet:pf}),ff={kernelName:sr,backendName:"webgl",kernelFunc:hf};const xf=Ue+`
  return exp(x);
`,mf=`
  vec4 result = exp(x);
  bvec4 isNaN = isnan(x);
  ...
  return result;
`,so=A({opSnippet:xf,packedOpSnippet:mf,cpuKernelImpl:Wu,dtype:"float32"}),gf={kernelName:lr,backendName:"webgl",kernelFunc:so};function Vt(n){const{inputs:e,attrs:t,backend:s}=n,{dim:o}=t,{input:a}=e,r=a.shape.length,c=a.shape.slice();let i=o;return o<0&&(_(-(r+1)<=o,()=>`Axis must be in the interval [${-(r+1)}, ${r}]`),i=r+o+1),c.splice(i,0,1),S({inputs:{x:a},backend:s,attrs:{shape:c}})}const Cf={kernelName:dr,backendName:"webgl",kernelFunc:Vt};const kn="return exp(x) - 1.0;",$f=A({opSnippet:kn,packedOpSnippet:kn,cpuKernelImpl:Mu}),vf={kernelName:pr,backendName:"webgl",kernelFunc:$f};class On{constructor(e,t,s){this.variableNames=["real","imag"];const o=t[1];this.outputShape=t;const a=s?`2.0 * ${Math.PI}`:`-2.0 * ${Math.PI}`,r=s?`${o}.0`:"1.0";let c;if(e==="real")c="return real * expR - imag * expI;";else if(e==="imag")c="return real * expI + imag * expR;";else throw new Error(`FFT component must be either "real" or "imag", got ${e}.`);this.userCode=`
    ...
    `}}const Tf={kernelName:gr,backendName:"webgl",kernelFunc:({inputs:n,backend:e})=>{const{image:t}=n,s=e,o=new wf(t.shape);return s.runWebGLProgram(o,[t],t.dtype)}};const An="return floor(x);",If=A({opSnippet:An,packedOpSnippet:An,cpuKernelImpl:Gu}),Nf={kernelName:Cr,backendName:"webgl",kernelFunc:If};const Ef=`
...
`,kf=`
  ...
  return vec4(result);
`,Of=B({opSnippet:Ef,packedOpSnippet:kf,dtype:"int32"}),Af={kernelName:$r,backendName:"webgl",kernelFunc:Of};class Df{constructor(e){this.variableNames=["A"];const t=G(),[s,o]=e;this.outputShape=e,this.userCode=`
      void main() {
        ivec3 coords = getOutputCoords();
        int texR = coords[0];
        int texC = coords[1];
    ...
    `}}function Hf(n,e){const t=["resRC.x","resRC.y","resRC.z","resRC.w"],s=[];for(let o=0;o<n.length;o++)o===2?s.push("index"):s.push(`${t[o]}`);return s.join()}function ao(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,indices:a}=e,{axis:r,batchDims:c}=s,i=K(r,o.shape)[0];if($().get("DEBUG")){const C=t.readSync(a.dataId),b=o.shape[i];for(let v=0;v<C.length;++v){const R=C[v];_(R<=b-1&&R>=0,()=>`GatherV2: the index value ${R} is not in [0, ${b-1}]`)}}const u=Tr(o,a,i,c),l=E(a.shape),d=[],p=S({inputs:{x:o},backend:t,attrs:{shape:[u.batchSize,u.outerSize,u.dimSize,u.sliceSize]}}),h=S({inputs:{x:a},backend:t,attrs:{shape:[u.batchSize,l/u.batchSize]}});d.push(p),d.push(h);const f=[u.batchSize,u.outerSize,l/u.batchSize,u.sliceSize];if(t.shouldExecuteOnCPU([o,a])||o.dtype==="string"){const C=t.bufferSync(h),b=t.bufferSync(p),v=Hu(b,C,f);return d.forEach(R=>t.disposeIntermediateTensorInfo(R)),t.makeTensorInfo(u.outputShape,v.dtype,v.values)}const m=new zf(p.shape,f),g=t.runWebGLProgram(m,[p,h],p.dtype);d.push(g);const x=S({inputs:{x:g},backend:t,attrs:{shape:u.outputShape}});return d.forEach(C=>t.disposeIntermediateTensorInfo(C)),x}const Xf={kernelName:wr,backendName:"webgl",kernelFunc:ao};const Kf="return float(a > b);",jf=`
  return vec4(greaterThan(a, b));
`,qf=B({opSnippet:Kf,packedOpSnippet:jf,cpuKernelImpl:Xu,dtype:"bool"}),Yf={kernelName:Ir,backendName:"webgl",kernelFunc:qf};const Qf="return float(a >= b);",Zf=`
  return vec4(greaterThanEqual(a, b));
`,Jf=B({opSnippet:Qf,packedOpSnippet:Zf,dtype:"bool",cpuKernelImpl:Ku}),ex={kernelName:Nr,backendName:"webgl",kernelFunc:Jf};function tx(n){const{inputs:e,backend:t}=n,{input:s}=e;return oo(s,!0,t)}const nx={kernelName:Er,backendName:"webgl",kernelFunc:tx};const sx="return float(!isnan(x) && !isinf(x));",ox=A({opSnippet:sx,dtype:"bool"}),ax={kernelName:kr,backendName:"webgl",kernelFunc:ox};const rx="return float(isinf(x));",ix=A({opSnippet:rx,dtype:"bool"}),cx={kernelName:Or,backendName:"webgl",kernelFunc:ix};const ux="return float(isnan(x));",lx=A({opSnippet:ux,dtype:"bool"}),dx={kernelName:Ar,backendName:"webgl",kernelFunc:lx};const px="return float(a < b);",hx=`
  return vec4(lessThan(a, b));
`,fx=B({opSnippet:px,packedOpSnippet:hx,cpuKernelImpl:ju,dtype:"bool"}),xx={kernelName:Dr,backendName:"webgl",kernelFunc:fx};const mx="return float(a <= b);",gx=`
  return vec4(lessThanEqual(a, b));
`,Cx=B({opSnippet:mx,packedOpSnippet:gx,cpuKernelImpl:qu,dtype:"bool"}),$x={kernelName:Pr,backendName:"webgl",kernelFunc:Cx};function vx(n){const{backend:e,attrs:t}=n,{start:s,stop:o,num:a}=t,r=Yu(s,o,a);return e.makeTensorInfo([r.length],"float32",r)}const bx={kernelName:Fr,backendName:"webgl",kernelFunc:vx};const Rx=Ue+`
...
`,Sx=`
  ...
  return result;
`,yx=A({opSnippet:Rx,packedOpSnippet:Sx,cpuKernelImpl:Qu}),wx={kernelName:_r,backendName:"webgl",kernelFunc:yx};const Tx=Ue+`
  return log(1.0 + x);
`,Ix=A({opSnippet:Tx}),Nx={kernelName:Lr,backendName:"webgl",kernelFunc:Ix};const Ex="return float(a >= 1.0 && b >= 1.0);",kx=`
  return vec4(
    vec4(greaterThanEqual(a, vec4(1.0))) *
    vec4(greaterThanEqual(b, vec4(1.0))));
`,Ox=B({opSnippet:Ex,packedOpSnippet:kx,dtype:"bool"}),Ax={kernelName:Br,backendName:"webgl",kernelFunc:Ox};const Dx="return float(!(x >= 1.0));",Px=A({opSnippet:Dx}),Fx={kernelName:Vr,backendName:"webgl",kernelFunc:Px};const _x="return float(a >= 1.0 || b >= 1.0);",Lx=`
  return min(
    vec4(greaterThanEqual(a, vec4(1.0))) +
    vec4(greaterThanEqual(b, vec4(1.0))),
    vec4(1.0));
`,Bx=B({opSnippet:_x,packedOpSnippet:Lx,dtype:"bool"}),Vx={kernelName:Ur,backendName:"webgl",kernelFunc:Bx};class Ux{constructor(e,t,s,o,a){this.variableNames=["x"],this.outputShape=[];const r=t,c=e[3]-1;this.outputShape=e;let i;const u=`float(${s}) + float(${o}) * sum`;a===.5?i=`inversesqrt(${u})`:a===1?i=`1.0/(${u})`:i=`exp(log(${u}) * float(-${a}));`,this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int r = coords[1];
    ...
    `}}const Mx=n=>{const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{depthRadius:a,bias:r,alpha:c,beta:i}=s,u=$().getBool("WEBGL_PACK_NORMALIZATION")?new Wx(o.shape,a,r,c,i):new Ux(o.shape,a,r,c,i);return t.runWebGLProgram(u,[o],o.dtype)},Gx={kernelName:Wr,backendName:"webgl",kernelFunc:Mx};class zx{constructor(e,t,s,o,a){this.variableNames=["inputImage","outputImage","dy"],this.outputShape=[],this.outputShape=e,this.depth=e[3],this.depthRadius=t,this.bias=s,this.alpha=o,this.beta=a,this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int r = coords[1];
    ...
    `}}const Hx=n=>{const{inputs:e,backend:t,attrs:s}=n,{x:o,y:a,dy:r}=e,{depthRadius:c,bias:i,alpha:u,beta:l}=s,d=new zx(o.shape,c,i,u,l);return t.runWebGLProgram(d,[o,a,r],o.dtype)},Xx={kernelName:Mr,backendName:"webgl",kernelFunc:Hx};function Kx(n,e,t,s){const o=E(e),r=E(n.shape)/o,c=S({inputs:{x:n},attrs:{shape:[r,o]},backend:s}),i=Te(c,n.dtype,"max",s),u=S({inputs:{x:i},attrs:{shape:t},backend:s});return s.disposeIntermediateTensorInfo(c),s.disposeIntermediateTensorInfo(i),u}function ro(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{reductionIndices:a,keepDims:r}=s,c=o.shape.length,i=K(a,o.shape);let u=i;const l=ne(u,c),d=l!=null,p=t.shouldExecuteOnCPU([o]);let h=o;if(d){if(p){const b=t.texData.get(h.dataId).values,v=new Array(c);for(let I=0;I<v.length;I++)v[I]=o.shape[l[I]];const R=nn(b,o.shape,o.dtype,l,v);h=t.makeTensorInfo(v,o.dtype);const N=t.texData.get(h.dataId);N.values=R}else h=yt(o,l,t);u=se(u.length,c)}re("max",u,c);const[f,m]=pe(h.shape,u);let g=f;r&&(g=he(f,i));let x;if(p){const b=t.texData.get(h.dataId).values,v=Zu(b,E(m),g,o.dtype);x=t.makeTensorInfo(g,o.dtype);const R=t.texData.get(x.dataId);R.values=v}else x=Kx(h,m,g,t);return d&&t.disposeIntermediateTensorInfo(h),x}const jx={kernelName:Gr,backendName:"webgl",kernelFunc:ro};const qx=sn+`
  return max(a, b);
`,Yx=`
  ...
  `+we+`
  return result;
`,Qx=B({opSnippet:qx,packedOpSnippet:Yx,cpuKernelImpl:Ju}),Zx={kernelName:zr,backendName:"webgl",kernelFunc:Qx};function Jx(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e;Pe(o,"maxPool");const{filterSize:a,strides:r,pad:c,dimRoundingMode:i}=s,u=1;_(Ze(r,u),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${r} and dilations '${u}'`);const l=Je(o.shape,a,r,u,c,i);if(l.filterWidth===1&&l.filterHeight===1&&z(l.inShape,l.outShape))return X({inputs:{x:o},backend:t});const d=new qe(l,"max",!1);return t.runWebGLProgram(d,[o],o.dtype)}const em={kernelName:Hr,backendName:"webgl",kernelFunc:Jx};function tm(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{filterSize:a,strides:r,pad:c,dataFormat:i,dimRoundingMode:u}=s,l=[1,1,1],d=vt(o.shape,a,r,l,c,u,i),p=new an(d,"max",!1);return t.runWebGLProgram(p,[o],o.dtype)}const nm={kernelName:Xr,backendName:"webgl",kernelFunc:tm};class sm{constructor(e){this.variableNames=["dy","maxPos"],this.outputShape=e.inShape;const t=e.strideHeight,s=e.strideWidth,o=e.dilationHeight,a=e.effectiveFilterHeight,r=e.effectiveFilterWidth,c=a-1-e.padInfo.top,i=r-1-e.padInfo.left,u=a*r-1;this.userCode=`
      const ivec2 pads = ivec2(${c}, ${i});
    ...
    `}}function am(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:a}=e,r=a,{filterSize:c,strides:i,pad:u,dimRoundingMode:l}=s,d=[1,1,1],p=vt(r.shape,c,i,d,u,l),h=new an(p,"max",!0),f=t.runWebGLProgram(h,[r],r.dtype),m=new om(p),g=t.runWebGLProgram(m,[o,f],r.dtype);return t.disposeIntermediateTensorInfo(f),g}const rm={kernelName:Kr,backendName:"webgl",kernelFunc:am};function im(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:a,output:r}=e,c=a;Pe([a,r],"maxPoolGrad");const{filterSize:i,strides:u,pad:l,dimRoundingMode:d}=s,p=Je(c.shape,i,u,1,l,d),h=!0,f=new qe(p,"max",h),m=t.runWebGLProgram(f,[c],c.dtype),g=new sm(p),x=t.runWebGLProgram(g,[o,m],c.dtype);return t.disposeIntermediateTensorInfo(m),x}const cm={kernelName:jr,backendName:"webgl",kernelFunc:im};function um(n,e,t,s){let o=new qe(t,"max",!1);const a=s.runWebGLProgram(o,[n],"float32");o=new qe(t,"max",!0,!0,e);const r=s.runWebGLProgram(o,[n],"float32");return[a,r]}const lm={kernelName:qr,backendName:"webgl",kernelFunc:({inputs:n,attrs:e,backend:t})=>{const{x:s}=n,{filterSize:o,strides:a,pad:r,includeBatchInIndex:c}=e,i=t;_(s.shape.length===4,()=>`Error in maxPool: input must be rank 4 but got rank ${s.shape.length}.`);const u=[1,1];_(Ze(a,u),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${a} and dilations '${u}'`);const l=Je(s.shape,o,a,u,r),[d,p]=um(s,c,l,i);return[d,p]}};function dm(n,e,t,s){const o=E(e),r=E(n.shape)/o,c=S({inputs:{x:n},attrs:{shape:[r,o]},backend:s}),i=Te(c,"float32","mean",s),u=S({inputs:{x:i},attrs:{shape:t},backend:s});return s.disposeIntermediateTensorInfo(c),s.disposeIntermediateTensorInfo(i),u}const pm={kernelName:Yr,backendName:"webgl",kernelFunc:({inputs:n,attrs:e,backend:t})=>{const{x:s}=n,{keepDims:o,axis:a}=e,r=t,c=s.shape.length,i=K(a,s.shape);let u=i;const l=ne(u,c),d=l!=null,p=r.shouldExecuteOnCPU([s]),h=[];let f=s;if(d){if(p){const v=r.texData.get(f.dataId).values,R=new Array(c);for(let w=0;w<R.length;w++)R[w]=s.shape[l[w]];const N=nn(v,s.shape,s.dtype,l,R);f=r.makeTensorInfo(R,s.dtype);const I=r.texData.get(f.dataId);I.values=N}else f=yt(s,l,r);h.push(f),u=se(u.length,c)}re("sum",u,c);const[m,g]=pe(f.shape,u);let x=m;o&&(x=he(m,i));const C=dm(f,g,x,r);for(const b of h)r.disposeIntermediateTensorInfo(b);return C}};function hm(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:a,keepDims:r}=s,c=o.shape.length,i=K(a,o.shape);let u=i;const l=ne(u,c);let d=o;l!=null&&(d=M({inputs:{x:o},backend:t,attrs:{perm:l}}),u=se(u.length,o.shape.length)),re("min",u,c);const[p,h]=pe(d.shape,u),f=E(h),m=S({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),g=Te(m,m.dtype,"min",t);let x;if(r){const C=he(p,i);x=S({inputs:{x:g},backend:t,attrs:{shape:C}})}else x=S({inputs:{x:g},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(g),l!=null&&t.disposeIntermediateTensorInfo(d),x}const fm={kernelName:Qr,backendName:"webgl",kernelFunc:hm};const xm=sn+`
  return min(a, b);
`,mm=`
  ...
  `+we+`
  return result;
`,gm=B({opSnippet:xm,packedOpSnippet:mm,cpuKernelImpl:el}),Cm={kernelName:Zr,backendName:"webgl",kernelFunc:gm};class $m{constructor(e,t,s){this.variableNames=["x"],this.outputShape=t.map((l,d)=>l[0]+e[d]+l[1]);const o=e.length,a=D(o),r=t.map(l=>l[0]).join(","),c=t.map((l,d)=>l[0]+e[d]).join(","),i=["coords[0]","coords[1]","coords[2]","coords[3]"].slice(0,o),u=s==="reflect"?0:1;if(o===1){this.userCode=`
        int start = ${r};
        int end = ${c};
    ...
    `}}const bm=({inputs:n,backend:e,attrs:t})=>{const{x:s}=n,{paddings:o,mode:a}=t,r=$().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new vm(s.shape,o,a):new $m(s.shape,o,a);return e.runWebGLProgram(r,[s],s.dtype)},Rm={kernelName:Jr,backendName:"webgl",kernelFunc:bm};const Sm=`if (b == 0.0) return NAN;
  return mod(a, b);`,ym=`
  vec4 result = mod(a, b);
  bvec4 isNaN = equal(b, vec4(0.0));
  `+we+`
  return result;
`,wm=B({opSnippet:Sm,packedOpSnippet:ym}),Tm={kernelName:ei,backendName:"webgl",kernelFunc:wm};class Im{constructor(e,t,s){this.variableNames=["probs"],this.customUniforms=[{name:"seed",type:"float"}],this.outputShape=[e,s],this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
        int batch = coords[0];
...
return a / b;`,Em=`
  ...
  return result;
`,io=B({opSnippet:Nm,packedOpSnippet:Em,checkOutOfBounds:!0}),km={kernelName:ti,backendName:"webgl",kernelFunc:io};const Dn="return a - b;",co=B({opSnippet:Dn,packedOpSnippet:Dn,supportsComplex:!0,cpuKernelImpl:bl}),Om={kernelName:ni,backendName:"webgl",kernelFunc:co};function uo(n){const{inputs:e,backend:t,attrs:s}=n,{logits:o}=e,{dim:a}=s,r=K([a],o.shape),c=ro({inputs:{x:o},backend:t,attrs:{reductionIndices:r,keepDims:!1}}),i=he(c.shape,r),u=S({inputs:{x:c},backend:t,attrs:{shape:i}}),l=co({inputs:{a:o,b:u},backend:t}),d=so({inputs:{x:l},backend:t}),p=wt({inputs:{x:d},backend:t,attrs:{axis:r,keepDims:!1}}),h=S({inputs:{x:p},backend:t,attrs:{shape:i}}),f=io({inputs:{a:d,b:h},backend:t});return t.disposeIntermediateTensorInfo(c),t.disposeIntermediateTensorInfo(u),t.disposeIntermediateTensorInfo(l),t.disposeIntermediateTensorInfo(d),t.disposeIntermediateTensorInfo(p),t.disposeIntermediateTensorInfo(h),f}const Am={kernelName:si,backendName:"webgl",kernelFunc:uo};function Dm(n){const{inputs:e,backend:t,attrs:s}=n,{logits:o}=e,{numSamples:a,seed:r,normalized:c}=s,i=c?o:uo({inputs:{logits:o},backend:t,attrs:{dim:o.shape.length-1}}),u=i.shape[0],l=i.shape[1],d=new Im(u,l,a),p=[[r]],h=t.runWebGLProgram(d,[i],"int32",p);return c||t.disposeIntermediateTensorInfo(i),h}const Pm={kernelName:oi,backendName:"webgl",kernelFunc:Dm};const Fm=J+`
  return -x;
`,_m=`
  vec4 result = -x;
  bvec4 isNaN = isnan(x);
...
`;function Lm(n){const{inputs:e,backend:t}=n,{x:s}=e;if(t.shouldExecuteOnCPU([s])){const a=t.texData.get(s.dataId),[r,c]=nl(a.values,s.shape,s.dtype);return t.makeTensorInfo(c,s.dtype,r)}let o;return $().getBool("WEBGL_PACK_UNARY_OPERATIONS")?o=new de(s.shape,_m):o=new ae(s.shape,Fm),t.runWebGLProgram(o,[s],s.dtype)}const Bm={kernelName:ai,backendName:"webgl",kernelFunc:Lm};const Vm=ii;function Um(n){$t("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");const{inputs:e,backend:t,attrs:s}=n,{boxes:o,scores:a}=e,{maxOutputSize:r,iouThreshold:c,scoreThreshold:i}=s,u=t.readSync(o.dataId),l=t.readSync(a.dataId),{selectedIndices:d}=Vm(u,l,r,c,i);return t.makeTensorInfo([d.length],"int32",new Int32Array(d))}const Wm={kernelName:ri,backendName:"webgl",kernelFunc:Um};const Mm=ui;function Gm(n){$t("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");const{inputs:e,backend:t,attrs:s}=n,{boxes:o,scores:a}=e,{maxOutputSize:r,iouThreshold:c,scoreThreshold:i,padToMaxOutputSize:u}=s,l=t.readSync(o.dataId),d=t.readSync(a.dataId),{selectedIndices:p,validOutputs:h}=Mm(l,d,r,c,i,u);return[t.makeTensorInfo([p.length],"int32",new Int32Array(p)),t.makeTensorInfo([],"int32",new Int32Array([h]))]}const zm={kernelName:ci,backendName:"webgl",kernelFunc:Gm};const Hm=di;function Xm(n){$t("tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead");const{inputs:e,backend:t,attrs:s}=n,{boxes:o,scores:a}=e,{maxOutputSize:r,iouThreshold:c,scoreThreshold:i,softNmsSigma:u}=s,l=t.readSync(o.dataId),d=t.readSync(a.dataId),p=r,h=c,f=i,m=u,{selectedIndices:g,selectedScores:x}=Hm(l,d,p,h,f,m);return[t.makeTensorInfo([g.length],"int32",new Int32Array(g)),t.makeTensorInfo([x.length],"float32",new Float32Array(x))]}const Km={kernelName:li,backendName:"webgl",kernelFunc:Xm};class jm{constructor(e,t,s,o){this.variableNames=["indices"],this.outputShape=[e,t],this.userCode=`
    ...
    `}}const qm=n=>{const{inputs:e,backend:t,attrs:s}=n,{indices:o}=e,{dtype:a,depth:r,onValue:c,offValue:i}=s,u=E(o.shape),l=new jm(u,r,c,i),d=S({inputs:{x:o},backend:t,attrs:{shape:[u]}}),p=t.runWebGLProgram(l,[d],a);t.disposeIntermediateTensorInfo(d);const h=[...o.shape,r],f=S({inputs:{x:p},backend:t,attrs:{shape:h}});return t.disposeIntermediateTensorInfo(p),f},Ym={kernelName:pi,backendName:"webgl",kernelFunc:qm};function Ct(n){const{inputs:e,backend:t}=n,{x:s}=e;if(s.dtype==="complex64"){const o=nt({inputs:{input:s},backend:t}),a=Ct({inputs:{x:o},backend:t}),r=Tt({inputs:{input:s},backend:t}),c=Ct({inputs:{x:r},backend:t}),i=xe({inputs:{real:a,imag:c},backend:t});return t.disposeIntermediateTensorInfo(o),t.disposeIntermediateTensorInfo(a),t.disposeIntermediateTensorInfo(r),t.disposeIntermediateTensorInfo(c),i}else return st({attrs:{shape:s.shape,dtype:s.dtype,value:s.dtype==="string"?"":0},backend:t})}const Qm={kernelName:hi,backendName:"webgl",kernelFunc:Ct};function lo(n){const{inputs:e,backend:t}=n,{x:s}=e;if(s.dtype==="string")throw new Error("onesLike is not supported under string dtype");if(s.dtype==="complex64"){const o=nt({inputs:{input:s},backend:t}),a=lo({inputs:{x:o},backend:t}),r=Tt({inputs:{input:s},backend:t}),c=Ct({inputs:{x:r},backend:t}),i=xe({inputs:{real:a,imag:c},backend:t});return t.disposeIntermediateTensorInfo(o),t.disposeIntermediateTensorInfo(a),t.disposeIntermediateTensorInfo(r),t.disposeIntermediateTensorInfo(c),i}else return st({attrs:{shape:s.shape,dtype:s.dtype,value:1},backend:t})}const Zm={kernelName:fi,backendName:"webgl",kernelFunc:lo};function Jm(n){const{inputs:e,backend:t,attrs:s}=n,{axis:o}=s;if(e.length===1)return Vt({inputs:{input:e[0]},backend:t,attrs:{dim:o}});const a=e[0].shape,r=e[0].dtype;e.forEach(l=>{mi(a,l.shape,"All tensors passed to stack must have matching shapes"),_(r===l.dtype,()=>"All tensors passed to stack must have matching dtypes")});const c=[],i=e.map(l=>{const d=Vt({inputs:{input:l},backend:t,attrs:{dim:o}});return c.push(d),d}),u=qs({inputs:i,backend:t,attrs:{axis:o}});return c.forEach(l=>t.disposeIntermediateTensorInfo(l)),u}const eg={kernelName:xi,backendName:"webgl",kernelFunc:Jm};class tg{constructor(e,t,s){this.variableNames=["x"],this.customUniforms=[{name:"value",type:"float"}],this.outputShape=t.map((u,l)=>u[0]+e[l]+u[1]);const o=e.length,a=D(o),r=t.map(u=>u[0]).join(","),c=t.map((u,l)=>u[0]+e[l]).join(","),i=["coords[0]","coords[1]","coords[2]","coords[3]"].slice(0,o);if(o===1){this.userCode=`
        int start = ${r};
        int end = ${c};
...
`,bg=`
  ...
  return result;
`,Rg=A({opSnippet:vg,packedOpSnippet:bg}),Sg={kernelName:wi,backendName:"webgl",kernelFunc:Rg};const yg=J+`
  return (x < 0.0) ? 0.0 : min(6.0, x);
`,wg=`
  vec4 result = min(x, vec4(6.)) * vec4(greaterThanEqual(x, vec4(0.0)));
  bvec4 isNaN = isnan(x);
  ...
  return result;
`,Tg=A({opSnippet:yg,packedOpSnippet:wg}),Ig={kernelName:Ti,backendName:"webgl",kernelFunc:Tg};class Ng{constructor(e,t,s,o,a){this.variableNames=["A"],this.outputShape=[];const[r,c,i,u]=e;this.outputShape=[r,t,s,u];const l=[o&&t>1?c-1:c,o&&s>1?i-1:i],d=[o&&t>1?t-1:t,o&&s>1?s-1:s];let p;a?p="(vec2(yRC) + vec2(0.5)) * effectiveInputOverOutputRatioRC - vec2(0.5)":p="vec2(yRC) * effectiveInputOverOutputRatioRC",this.userCode=`
    ...
    `}}function kg(n){const{inputs:e,backend:t,attrs:s}=n,{images:o}=e,{alignCorners:a,halfPixelCenters:r,size:c}=s,[i,u]=c,l=$().getBool("WEBGL_PACK_IMAGE_OPERATIONS")?new Eg(o.shape,i,u,a,r):new Ng(o.shape,i,u,a,r);return t.runWebGLProgram(l,[o],"float32")}const Og={kernelName:Ii,backendName:"webgl",kernelFunc:kg};class Ag{constructor(e,t,s){this.variableNames=["dy"],this.outputShape=[],this.outputShape=t;const[,o,a]=t,[,r,c]=e,i=[s&&r>1?o-1:o,s&&c>1?a-1:a],u=[s&&r>1?r-1:r,s&&c>1?c-1:c],l=i[0]/u[0],d=i[1]/u[1],p=1/l,h=1/d,f=Math.ceil(p)*2+2,m=Math.ceil(h)*2+2;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int d = coords[3];
    ...
    `}}function Dg(n){const{inputs:e,backend:t,attrs:s}=n,{images:o,dy:a}=e,{alignCorners:r}=s,c=new Ag(a.shape,o.shape,r);return t.runWebGLProgram(c,[a],a.dtype)}const Pg={kernelName:Ni,backendName:"webgl",kernelFunc:Dg};class Fg{constructor(e,t,s,o,a){this.variableNames=["A"],this.outputShape=[];const[r,c,i,u]=e;this.outputShape=[r,t,s,u];const l=[o&&t>1?c-1:c,o&&s>1?i-1:i],d=[o&&t>1?t-1:t,o&&s>1?s-1:s],p=o?"0.5":"0.0";let h;a?h="max((vec2(yRC) + vec2(0.5)) * effectiveInputOverOutputRatioRC, vec2(0.0))":h="vec2(yRC) * effectiveInputOverOutputRatioRC",this.userCode=`
      const vec2 effectiveInputOverOutputRatioRC = vec2(
          ${l[0]/d[0]},
          ${l[1]/d[1]});
      const vec2 inputShapeRC = vec2(${c}.0, ${i}.0);
    ...
    `}}function Lg(n){const{inputs:e,backend:t,attrs:s}=n,{images:o}=e,{alignCorners:a,halfPixelCenters:r,size:c}=s,[i,u]=c,l=$().getBool("WEBGL_PACK_IMAGE_OPERATIONS")?new _g(o.shape,i,u,a,r):new Fg(o.shape,i,u,a,r);return t.runWebGLProgram(l,[o],o.dtype)}const Bg={kernelName:Ei,backendName:"webgl",kernelFunc:Lg};class Vg{constructor(e,t,s){this.variableNames=["dy"],this.outputShape=[],this.outputShape=t;const[,o,a]=t,[,r,c]=e,i=[s&&r>1?o-1:o,s&&c>1?a-1:a],u=[s&&r>1?r-1:r,s&&c>1?c-1:c],l=i[0]/u[0],d=i[1]/u[1],p=1/l,h=1/d,f=Math.ceil(p)*2+2,m=Math.ceil(h)*2+2;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int d = coords[3];
    ...
    `}}function Ug(n){const{inputs:e,backend:t,attrs:s}=n,{images:o,dy:a}=e,{alignCorners:r}=s,c=new Vg(a.shape,o.shape,r);return t.runWebGLProgram(c,[a],a.dtype)}const Wg={kernelName:ki,backendName:"webgl",kernelFunc:Ug};class Mg{constructor(e,t){this.variableNames=["x"];const s=e.length;if(s>4)throw new Error(`WebGL backend: Reverse of rank-${s} tensor is not yet supported`);if(this.outputShape=e,s===1){this.userCode=`
        void main() {
    ...
    `;function i(f){return p(f)}function u(f){return f[s-1]="("+f[s-1]+" + 1)",p(f)}function l(f){return f[s-2]="("+f[s-2]+" + 1)",p(f)}function d(f){return f[s-1]="("+f[s-1]+" + 1)",f[s-2]="("+f[s-2]+" + 1)",p(f)}function p(f){const m=e.map((C,b)=>h(b,f)),g=m.join(","),x=m.slice(-2).join(",");return`getChannel(getX(${g}), vec2(${x}))`}function h(f,m){return t.indexOf(f)!==-1&&e[f]!==1?`${e[f]} - ${m[f]} - 1`:`${m[f]}`}}}function zg(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{dims:a}=s,r=o.shape.length,c=K(a,o.shape);if(r===0)return X({inputs:{x:o},backend:t});const i=$().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new Gg(o.shape,c):new Mg(o.shape,c);return t.runWebGLProgram(i,[o],o.dtype)}const Hg={kernelName:Oi,backendName:"webgl",kernelFunc:zg};class Xg{constructor(e,t){this.variableNames=["Image"],this.outputShape=[],this.customUniforms=[{name:"params",type:"vec4"}];const s=e[1],o=e[2];this.outputShape=e;let a="";typeof t=="number"?a=`float outputValue = ${t.toFixed(2)};`:a=`
    ...
    `}}const Kg={kernelName:Ai,backendName:"webgl",kernelFunc:({inputs:n,attrs:e,backend:t})=>{const{image:s}=n,{radians:o,fillValue:a,center:r}=e,c=t,i=new Xg(s.shape,a),[u,l]=Di(r,s.shape[1],s.shape[2]),d=[[u,l,Math.sin(o),Math.cos(o)]];return c.runWebGLProgram(i,[s],s.dtype,d)}};const jg=`
...
`,qg=A({opSnippet:jg}),Yg={kernelName:Pi,backendName:"webgl",kernelFunc:qg};const Qg="return inversesqrt(x);",Zg=A({opSnippet:Qg,cpuKernelImpl:ul}),Jg={kernelName:Fi,backendName:"webgl",kernelFunc:Zg};class rn{constructor(e,t,s,o,a,r,c=!0,i=!1){this.variableNames=["updates","indices","defaultValue"],this.outputShape=r;const u=D(a.length),l=D(r.length);let d="";s===1?d="i":s===2&&(d="i, j");const p=`getIndices(${d})`;let h="";o===1?h="i":o===2&&(h="i, coords[1]");const f=`getUpdates(${h})`;let m="";i&&(m="coords[0], coords[1]");const g=`getDefaultValue(${m})`,x=t>1?"strides[j]":"strides";this.userCode=`
        ${u} strides = ${u}(${a});
     ...
     `}}function oC(n){const{inputs:e,backend:t,attrs:s}=n,{sortedSequence:o,values:a}=e,{side:r}=s,c=new sC(o.shape[0],o.shape[1],a.shape[1],r),i=[[o.shape[1]]];return t.runWebGLProgram(c,[o,a],"int32",i)}const aC={kernelName:Li,backendName:"webgl",kernelFunc:oC};class rC{constructor(e,t,s){this.variableNames=["c","a","b"],this.outputShape=t;let o,a;if(s>4)throw Error(`Where for rank ${s} is not yet supported`);if(s===1)a="resRC",o="resRC";else{const c=["resRC.x","resRC.y","resRC.z","resRC.w"],i=[],u=[];for(let l=0;l<t.length;l++)u.push(`${c[l]}`),l<e&&i.push(`${c[l]}`);o=i.join(),a=u.join()}const r=D(s);this.userCode=`
      void main() {
    ...
    `}}function iC(n){const{inputs:e,backend:t}=n,{condition:s,t:o,e:a}=e,r=new rC(s.shape.length,o.shape,o.shape.length);return t.runWebGLProgram(r,[s,o,a],ke(o.dtype,a.dtype))}const cC={kernelName:Bi,backendName:"webgl",kernelFunc:iC};const uC=`
  // Stable and Attracting Fixed Point (0, 1) for Normalized Weights.
  // see: https://arxiv.org/abs/1706.02515
  float scaleAlpha = ${Ui};
  float scale = ${Wi};
  return (x >= 0.0) ? scale * x : scaleAlpha * (exp(x) - 1.0);
`,lC=A({opSnippet:uC}),dC={kernelName:Vi,backendName:"webgl",kernelFunc:lC};const pC=Ue+`
...
`,hC=`
  ...
  return result;
`,fC=A({opSnippet:pC,packedOpSnippet:hC,cpuKernelImpl:dl}),xC={kernelName:Mi,backendName:"webgl",kernelFunc:fC};const mC=`
  if (isnan(x)) { return 0.0; }
  return sign(x);
`,gC=A({opSnippet:mC}),CC={kernelName:Gi,backendName:"webgl",kernelFunc:gC};const $C=Ue+`
  return sin(x);
`,vC=`
  vec4 result = sin(x);
  bvec4 isNaN = isnan(x);
  ${we}
  return result;
`,bC=A({opSnippet:$C,packedOpSnippet:vC}),RC={kernelName:zi,backendName:"webgl",kernelFunc:bC};const SC=`
  float e2x = exp(x);
  return (e2x - 1.0 / e2x) / 2.0;
`,yC=A({opSnippet:SC}),wC={kernelName:Hi,backendName:"webgl",kernelFunc:yC};const TC=`
  ...
  return result;
`,IC=A({opSnippet:TC}),NC={kernelName:Xi,backendName:"webgl",kernelFunc:IC};const EC=n=>{const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{blockShape:a,paddings:r}=s;_(o.shape.length<=4,()=>"spaceToBatchND for rank > 4 with a WebGL backend not implemented yet");const c=a.reduce((x,C)=>x*C),i=[[0,0]];i.push(...r);for(let x=1+a.length;x<o.shape.length;++x)i.push([0,0]);const u=[],l=po({inputs:{x:o},backend:t,attrs:{paddings:i,constantValue:0}}),d=Vn(l.shape,a,c,!1),p=Un(d.length,a.length,!1),h=Wn(l.shape,a,c,!1),f=S({inputs:{x:l},backend:t,attrs:{shape:d}}),m=M({inputs:{x:f},backend:t,attrs:{perm:p}}),g=S({inputs:{x:m},backend:t,attrs:{shape:h}});return u.push(l),u.push(f),u.push(m),u.forEach(x=>t.disposeIntermediateTensorInfo(x)),g},kC={kernelName:Ki,backendName:"webgl",kernelFunc:EC};function OC(n){const{inputs:e,backend:t}=n,{indices:s,values:o,denseShape:a,defaultValue:r}=e;if(a.shape.length!==1)throw new Error(`Dense shape must be a vector, saw:
         ${a.shape}`);if(s.shape.length!==2)throw new Error(`Indices must be a matrix, saw:
         ${s.shape}`);if(o.shape.length!==1)throw new Error(`Values must be a vector, saw:
         ${o.shape}`);if(r.shape.length!==0)throw new Error(`Default value must be a scalar, saw:
        ${r.shape}`);const c=t.readSync(s.dataId),i=t.readSync(o.dataId),u=t.readSync(a.dataId),l=t.readSync(r.dataId)[0],[d,p,h,f,m]=hl(c,s.shape,s.dtype,i,o.dtype,u,l);return[t.makeTensorInfo(p,s.dtype,d),t.makeTensorInfo([p[0]],o.dtype,h),t.makeTensorInfo([f.length],"bool",new Uint8Array(f.map(g=>Number(g)))),t.makeTensorInfo([m.length],s.dtype,new Int32Array(m))]}const AC={kernelName:ji,backendName:"webgl",kernelFunc:OC};function DC(n){const{inputs:e,backend:t}=n,{inputIndices:s,inputShape:o,newShape:a}=e;if(s.shape.length!==2)throw new Error(`Input indices should be a matrix but received shape ${s.shape}`);if(o.shape.length!==1)throw new Error(`Input shape should be a vector but received shape ${o.shape}`);if(a.shape.length!==1)throw new Error(`Target shape should be a vector but received shape ${a.shape}`);const r=Array.from(t.readSync(o.dataId)),c=t.readSync(s.dataId),i=Array.from(t.readSync(a.dataId)),[u,l,d]=fl(c,s.shape,s.dtype,r,i);return[t.makeTensorInfo(l,s.dtype,u),t.makeTensorInfo([d.length],a.dtype,new Int32Array(d))]}const PC={kernelName:qi,backendName:"webgl",kernelFunc:DC};function FC(n){const{inputs:e,backend:t}=n,{data:s,indices:o,segmentIds:a}=e;if(s.shape.length<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(o.shape.length!==1)throw new Error(`Indices should be a vector but received shape
              ${o.shape}`);if(a.shape.length!==1)throw new Error(`Segment ids should be a vector but received shape
              ${a.shape}`);const r=t.readSync(s.dataId),c=t.readSync(o.dataId),i=t.readSync(a.dataId),[u,l]=_s(r,s.shape,s.dtype,c,i,!0);return t.makeTensorInfo(l,s.dtype,u)}const _C={kernelName:Yi,backendName:"webgl",kernelFunc:FC};function LC(n){const{inputs:e,backend:t}=n,{data:s,indices:o,segmentIds:a}=e;if(s.shape.length<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(o.shape.length!==1)throw new Error(`Indices should be a vector but received shape
             ${o.shape}`);if(a.shape.length!==1)throw new Error(`Segment ids should be a vector but received shape
             ${a.shape}`);const r=t.readSync(s.dataId),c=t.readSync(o.dataId),i=t.readSync(a.dataId),[u,l]=_s(r,s.shape,s.dtype,c,i);return t.makeTensorInfo(l,s.dtype,u)}const BC={kernelName:Qi,backendName:"webgl",kernelFunc:LC};function VC(n){const{inputs:e,backend:t,attrs:s}=n,{sparseIndices:o,sparseValues:a,defaultValue:r}=e,{outputShape:c}=s,{sliceRank:i,numUpdates:u,sliceSize:l,strides:d,outputSize:p}=Ht(a,o,c),h=!1;if(a.dtype==="string"){const x=t.bufferSync(o),C=t.bufferSync(a),b=Wt(t.readSync(r.dataId)[0]),v=ll(x,C,c,p,l,u,i,d,b,h);return t.makeTensorInfo(c,v.dtype,v.values)}const f=new rn(u,i,o.shape.length,a.shape.length,d,[p,1],h),m=t.runWebGLProgram(f,[a,o,r],a.dtype),g=S({inputs:{x:m},backend:t,attrs:{shape:c}});return t.disposeIntermediateTensorInfo(m),g}const UC={kernelName:Zi,backendName:"webgl",kernelFunc:VC};function WC(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{numOrSizeSplits:a,axis:r}=s,c=K(r,o.shape)[0],i=ec(o,a,c),u=o.shape.length,l=new Array(u).fill(0),d=o.shape.slice();return i.map(p=>{const h=[...d];h[c]=p;const f=We({inputs:{x:o},backend:t,attrs:{begin:l,size:h}});return l[c]+=p,f})}const MC={kernelName:Ji,backendName:"webgl",kernelFunc:WC};const Pn="return sqrt(x);",GC=A({opSnippet:Pn,packedOpSnippet:Pn,cpuKernelImpl:xl}),zC={kernelName:tc,backendName:"webgl",kernelFunc:GC};const HC="return x * x;",XC=A({opSnippet:HC}),KC={kernelName:nc,backendName:"webgl",kernelFunc:XC};const Fn="return (a - b) * (a - b);",jC=B({opSnippet:Fn,packedOpSnippet:Fn}),qC={kernelName:sc,backendName:"webgl",kernelFunc:jC};function YC(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e;if(o.dtype!=="string")throw new Error("Input must be of datatype string");const a=t.readSync(o.dataId),r=At(a),c=ml(r,"string",s);return t.makeTensorInfo(o.shape,"string",c)}const QC={kernelName:oc,backendName:"webgl",kernelFunc:YC};function ZC({inputs:n,attrs:e,backend:t}){const{x:s}=n,o=J+`
    return x > 0.0 ? 1.0 : float(${e.alpha});
  `,a=new ae(s.shape,o);return t.runWebGLProgram(a,[s],s.dtype)}const JC={kernelName:ac,backendName:"webgl",kernelFunc:ZC};class e${constructor(e,t,s){this.variableNames=["x"],this.outputShape=s;const o=s.length,a=D(s.length),r=D(s.length);let c="";if(o===1)c="coords * strides + begin";else{let i=0;c=s.map((u,l)=>(i++,s.length===1?`coords * strides[${l}] + begin[${l}]`:`coords[${i-1}] * strides[${l}] + begin[${l}]`)).join(",")}this.userCode=`
      ${a} begin = ${a}(${e});
      ${a} strides = ${a}(${t});
...
`,h$=A({opSnippet:p$}),f$={kernelName:hc,backendName:"webgl",kernelFunc:h$};function x$(n){const{inputs:e,backend:t,attrs:s}=n,{tensor:o,indices:a,updates:r}=e,{sliceRank:c,numUpdates:i,sliceSize:u,strides:l,outputSize:d}=Ht(r,a,o.shape),p=[d/u,u];if(d===0)return t.makeTensorInfo(o.shape,a.dtype);const h=S({inputs:{x:a},backend:t,attrs:{shape:[i,c]}}),f=S({inputs:{x:r},backend:t,attrs:{shape:[i,u]}}),m=S({inputs:{x:o},backend:t,attrs:{shape:p}}),g=new rn(i,c,h.shape.length,f.shape.length,l,p,!1,!0),x=t.runWebGLProgram(g,[f,h,m],m.dtype),C=S({inputs:{x},backend:t,attrs:{shape:o.shape}});return t.disposeIntermediateTensorInfo(h),t.disposeIntermediateTensorInfo(f),t.disposeIntermediateTensorInfo(m),t.disposeIntermediateTensorInfo(x),C}const m$={kernelName:fc,backendName:"webgl",kernelFunc:x$};class g${constructor(e,t){this.variableNames=["A"];const s=new Array(e.length);for(let r=0;r<s.length;r++)s[r]=e[r]*t[r];this.outputShape=s,this.rank=s.length;const o=D(this.rank),a=C$(e);this.userCode=`
    ...
    void main() {
     ...
     `}}function ge(n,e){e!==null&&n.disposeIntermediateTensorInfo(e)}function _n(n){let e=1;for(;e<n;)e*=2;return e}function R$(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{k:a,sorted:r}=s,c=$().getNumber("TOPK_LAST_DIM_CPU_HANDOFF_SIZE_THRESHOLD"),i=$().getNumber("TOPK_K_CPU_HANDOFF_THRESHOLD"),u=o.shape,l=u[u.length-1];if(t.shouldExecuteOnCPU([o])||l<c||a>i){const k=t.readSync(o.dataId),[P,F]=Sl(k,u,o.dtype,a,r);return[t.makeTensorInfo(P.shape,P.dtype,P.values),t.makeTensorInfo(F.shape,F.dtype,F.values)]}if(a===0)return u[u.length-1]=0,[t.makeTensorInfo(u,o.dtype,[]),t.makeTensorInfo(u,"int32",[])];if(l===1)return[o,st({attrs:{shape:u,dtype:"int32",value:0},backend:t})];const d=t.texData.get(o.dataId),p=d!==null&&d.isPacked,h=p?t.unpackTensor(o):o,m=E(u)/l,g=S({inputs:{x:h},attrs:{shape:[m,l]},backend:t});p&&ge(t,h);const x=_n(a),C=_n(l);let b=null;const v=()=>b===null?[g,g]:[g,b],R=(k,P,F)=>{const oe=v(),H=new v$(F),Z=[[l],[b===null?1:0],[Number.NEGATIVE_INFINITY],[k],[P]],ee=b;b=t.runWebGLProgram(H,oe,"int32",Z),ge(t,ee)};for(let k=1;k<x;k*=2){const P=k*2;for(let F=k;F>=1;F/=2)R(P,F,[m,C])}for(let k=C;k>x;k/=2){const P=v(),F=new b$([m,k/2]),H=[[l],[b===null?1:0],[x]],j=b;b=t.runWebGLProgram(F,P,"int32",H),ge(t,j);const Z=x/2,ee=Z*2;for(let U=Z;U>=1;U/=2)R(ee,U,b.shape)}let N=b;b=We({inputs:{x:b},backend:t,attrs:{begin:0,size:[m,a]}}),ge(t,N);let I=ao({inputs:{x:g,indices:b},backend:t,attrs:{axis:1,batchDims:1}});ge(t,g);const w=u.slice(0,-1);w.push(a),N=b,b=S({inputs:{x:b},attrs:{shape:w},backend:t}),ge(t,N);const O=I;return I=S({inputs:{x:I},attrs:{shape:w},backend:t}),ge(t,O),[I,b]}const S$={kernelName:mc,backendName:"webgl",kernelFunc:R$};class y${constructor(e,t,s,o,a,r){this.variableNames=["Image","Transforms"],this.outputShape=r;const c=s==="nearest"?1:2;let i;switch(o){case"constant":i=1;break;case"reflect":i=2;break;case"wrap":i=3;break;case"nearest":i=4;break;default:i=1;break}this.userCode=`
        ...
        `}}function w$(n){const{inputs:e,backend:t,attrs:s}=n,{image:o,transforms:a}=e,{interpolation:r,fillMode:c,fillValue:i,outputShape:u}=s,[l,d,p,h]=o.shape,[f,m]=u??[d,p],g=[l,f,m,h],x=new y$(d,p,r,c,i,g);return t.runWebGLProgram(x,[o,a],"float32")}const T$={kernelName:gc,backendName:"webgl",kernelFunc:w$};function I$(n){const{inputs:e,attrs:t,backend:s}=n,{axis:o}=t,{x:a}=e;Pe(a,"unique"),console.warn("WARNING: ","UI might be locked temporarily as data is being downloaded");const r=s.readSync(a.dataId),{outputValues:c,outputShape:i,indices:u}=yl(r,o,a.shape,a.dtype);return[s.makeTensorInfo(i,a.dtype,c),s.makeTensorInfo([u.length],"int32",u)]}const N$={kernelName:Cc,backendName:"webgl",kernelFunc:I$};function E$(n){const{inputs:e,backend:t,attrs:s}=n,{value:o}=e;let{axis:a}=s;a<0&&(a+=o.shape.length);const r=o,c=r.shape.length,i=o.shape[a],u=new Array(c-1);let l=0;for(let m=0;m<c;m++)m!==a&&(u[l++]=r.shape[m]);const d=[],p=new Array(c).fill(0),h=r.shape.slice();h[a]=1;const f=new Array(i);for(let m=0;m<f.length;m++){p[a]=m;const g=We({inputs:{x:r},backend:t,attrs:{begin:p,size:h}}),x=S({inputs:{x:g},backend:t,attrs:{shape:u}});f[m]=x,d.push(g)}return d.forEach(m=>t.disposeIntermediateTensorInfo(m)),f}const k$={kernelName:$c,backendName:"webgl",kernelFunc:E$};class O${constructor(e,t){this.variableNames=["x","segmentIds"];const s=e.windowSize,o=e.batchSize,a=e.inSize,r=e.numSegments,c=r*Math.ceil(a/s);this.outputShape=[o,c];const i="0.0",u="sumValue",l=Math.floor(s/4)*4,d=s%4,p=`
